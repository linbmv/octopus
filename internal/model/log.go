...
const (
	...
	AttemptClientCancel AttemptStatus = "client_canceled" // 客户端断开或请求上下文取消
...
type RelayLog struct {
	...
	ReasoningTokens   int              `json:"reasoning_tokens" gorm:"not null;default:0"` // 推理 Token（包含在输出 Token 中）
